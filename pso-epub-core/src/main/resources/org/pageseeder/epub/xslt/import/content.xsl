...
-->
  ...
  <xsl:variable name="inline">
    <xsl:for-each select="$configDoc/config/inline/element/@xhtml">
      <xsl:choose>
  ...
  <xsl:variable name="block">
    <xsl:for-each select="$configDoc/config/block/element/@xhtml">
      <xsl:choose>
        <xsl:when test="position() = last()">
          <xsl:value-of select="." />
        </xsl:when>
  ...
  <xsl:variable name="table">
    <xsl:for-each select="$configDoc/config/table/element/@xhtml">
      <xsl:choose>
        <xsl:when test="position() = last()">
          <xsl:value-of select="." />
        </xsl:when>
  ...
  <xsl:variable name="lists">
    <xsl:for-each select="$configDoc/config/lists/element/@xhtml">
      <xsl:choose>
        <xsl:when test="position() = last()">
          <xsl:value-of select="." />
        </xsl:when>
...
<!--       <xsl:choose> -->
<!--         <xsl:when test="$configDoc/config/inline/element[@xhtml=*/name()][@psml='inline']"> -->
<!--           <xsl:element name="inline"> -->
<!--             <xsl:attribute name="label"><xsl:value-of select="$configDoc/config/inline/element[@xhtml='name()']/@value"/></xsl:attribute> -->
<!--             <xsl:apply-templates mode="content" select="." /> -->
<!--           </xsl:element> -->
<!--         </xsl:when> -->
<!--         <xsl:otherwise> -->
<!--           <xsl:element name="{$configDoc/config/inline/element[@xhtml=*/name()]/@psml}"> -->
<!--             <xsl:apply-templates mode="content" select="." /> -->
<!--           </xsl:element> -->
<!--         </xsl:otherwise> -->
<!--       </xsl:choose> -->
...
<!--       <xsl:choose> -->
<!--         <xsl:when test="$configDoc/config/block/element[@xhtml=*/name()][@psml='block']"> -->
<!--           <xsl:element name="block"> -->
<!--             <xsl:attribute name="label"><xsl:value-of select="$configDoc/config/block/element[@xhtml='name()']/@value"/></xsl:attribute> -->
<!--             <xsl:apply-templates mode="content" select="." /> -->
<!--           </xsl:element> -->
<!--         </xsl:when> -->
<!--         <xsl:when test="$configDoc/config/block/element[@xhtml=*/name()][@psml='heading']"> -->
<!--           <xsl:element name="heading"> -->
<!--             <xsl:attribute name="level"><xsl:value-of select="$configDoc/config/block/element[@xhtml='name()']/@value"/></xsl:attribute> -->
<!--             <xsl:apply-templates mode="content" select="." /> -->
<!--           </xsl:element> -->
<!--         </xsl:when> -->
<!--         <xsl:otherwise> -->
<!--           <xsl:element name="{$configDoc/config/block/element[@xhtml=*/name()]/@psml}"> -->
<!--             <xsl:apply-templates mode="content" select="." /> -->
<!--           </xsl:element> -->
<!--         </xsl:otherwise> -->
<!--       </xsl:choose> -->
...
<!--       <xsl:element name="{$configDoc/config/table/element[@xhtml=*/name()]/@psml}"> -->
<!--         <xsl:apply-templates mode="content" select="." /> -->
<!--       </xsl:element> -->
<!--     </xsl:when> -->
<!--     <xsl:when test="matches(*/name(),$lists)"> -->
<!--       <xsl:element name="{$configDoc/config/lists/element[@xhtml=*/name()]/@psml}"> -->
<!--         <xsl:apply-templates mode="content" select="." /> -->
<!--       </xsl:element> -->
<!--     </xsl:when> -->
<!--     <xsl:otherwise> -->
